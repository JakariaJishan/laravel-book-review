...
class Book extends Model
{
    ...
    public function scopeGetTitle(Builder $query, string $title): Builder
    {
    ...
    //NOTE:this is showing query error. will fix later
    public function scopeMinReviews(Builder $query, int $minReviews): Builder
    {
        return $query->havingRaw('reviews_count >= ?', [$minReviews]);
    }

    private function dateRangeFilter(Builder $q, $from = null, $to = null): void
    {
        if ($from && !$to) {
